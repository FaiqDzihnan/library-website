...
function toggleLogin (){
    document.querySelector(".wrapperlogin").classList.toggle("open")
}

//POPUP Sign Up
function toggleSignUp (){
    document.querySelector(".wrappersignup").classList.toggle("open")
}

//Show menu in mobile device mode
function showMenu (){
    document.getElementById("menuClick").style.right ="-20px";
    document.getElementById("topNav").style.left = "190px";
}
function hideMenu (){
    document.getElementById("menuClick").style.right ="-300px";
    document.getElementById("topNav").style.left = "390px"
}
